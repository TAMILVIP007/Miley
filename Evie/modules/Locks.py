        ...
        if event.chat_id == c["id"]:
            if c["phone"] == True:
             ...
             if "@gmail.com" in event.text or "@yahoo.com" in event.text:
                ...
                if (
                    event.media
                    and event.media.document.mime_type == "audio/m4a"
                ):
                    await event.delete()
            elif c["command"] == True:
             if event.text.startswith("/"):
                ...
                if event.media and not event.media.geo is None:
                    await event.delete()
...
async def lk(event):
    ...
    emlink = None
    changeinfo = None
    if input_str in ["message", "msg"]:
        msg = True
    elif input_str == "media":
       media = True
    elif input_str == "sticker":
       sticker = True
    elif input_str in ["gif", "gifs"]:
        gif = True
    elif input_str in ["game", "games"]:
        gamee = True
